                ...
                <View style={styles.listItemCon}>
                    <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
                        ...
                        <View style={styles.textListHead} >
                            <Text style={{ fontSize: 18, fontFamily: 'Prompt_500Medium' }}>ติดต่อเรา</Text>
                        </View>
                        <View >
                    ...
                    <View style={{ marginTop: 0, }}>
                        ...
                        <View style={styles.textListHead2}>
                                <View style={styles.profile}>
                                    ...
                                    <View>
                                        <Text style={{ fontSize: 17, fontWeight: 500 }}> แชทพูดคุยกับเรา</Text>
                                    </View>
                                </View>
                            ...
                            <View style={styles.textListHead2}>
                                <View style={styles.profile}>
                                    ...
                                    <View>
                                        <Text style={{ fontSize: 17, fontWeight: 500 }}> 0958467417</Text>
                                    </View>
                                </View>
                            ...
                            <View style={styles.textListHead2}>
                                <View style={styles.profile}>
                                    ...
                                    <View>
                                        <Text style={{ fontSize: 17, fontWeight: 500 }}> LoadMaster@gmail.com</Text>
                                    </View>
                                </View>
                            ...
                            <View style={styles.textListHead2}>
                                <View style={styles.profile}>
                                    ...
                                    <View>
                                        <Text style={{ fontSize: 17, fontWeight: 500 }}> Line ID : @mac2hand</Text>
                                    </View>
                                </View>
                            ...
                            <View style={styles.textListHead2}>
                                <View style={styles.profile}>
                                    ...
                                    <View>
                                        <Text style={{ fontSize: 17, fontWeight: 500 }}> 064025xxxx</Text>
                                    </View>
                                </View>
